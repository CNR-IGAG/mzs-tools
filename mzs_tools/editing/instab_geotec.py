...
def instab_geotec_form_init(dialog, layer, feature):
    codici_instab = []
    ...
    for i in codici_instab_layer.getFeatures(QgsFeatureRequest().setFlags(QgsFeatureRequest.NoGeometry)):
        if (
            int(i.attributes()[1]) != 3001
            and int(i.attributes()[1]) != 3002
            and int(i.attributes()[1]) != 3050
            and int(i.attributes()[1]) != 3051
            and int(i.attributes()[1]) != 3052
            and int(i.attributes()[1]) != 3053
            and int(i.attributes()[1]) != 3060
            and int(i.attributes()[1]) != 3061
            and int(i.attributes()[1]) != 3062
            and int(i.attributes()[1]) != 3070
            and int(i.attributes()[1]) != 3080
        ):
    ...
    cod_instab.currentIndexChanged.connect(partial(update_lineedit_tipo_i, cod_instab, lineedit_tipo_i))
