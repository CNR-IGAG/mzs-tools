...
#		 self.steps = steps
    ...
    def work(self):
        ...
        LISTA_LIV_2_3 = [["Zone stabili liv 3", "Zone stabili liv 2", "Stab.shp", "Stab", "ID_z"],
                         ["Zone instabili liv 3", "Zone instabili liv 2",
                             "Instab.shp", "Instab", "ID_i"],
        ...
        LISTA_QUERY = ["""INSERT INTO 'sito_puntuale'(pkey_spu, ubicazione_prov, ubicazione_com, ID_SPU, indirizzo, coord_X, coord_Y,
					...
					valore, attend_mis, tab_curve, note_par, data_par, pkey_indpu FROM A.parametri_puntuali;""",
                       """INSERT INTO 'curve'(pkey_curve, id_parpu, cond_curve, varx, vary, pkey_parpu) SELECT pkuid, id_parpu, cond_curve, varx, vary, pkey_parpu FROM A.curve;""",
					...
					desc_modcoord, aquota, bquota, data_sito, note_sito FROM A.sito_lineare;""",
                       """INSERT INTO 'indagini_lineari'(pkey_indln, id_sln, classe_ind, tipo_ind, ID_INDLN, id_indlnex, arch_ex, note_indln, data_ind, doc_pag, doc_ind, pkey_sln)
