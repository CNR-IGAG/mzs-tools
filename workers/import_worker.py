...
class ImportWorker(AbstractWorker):
    ...
    def work(self):
        ...
        self.copy_files(os.path.join(self.in_dir, "Indagini"), os.path.join(path_tabelle, "Indagini"))
        ...
        if self.check_sito_p is True and os.path.exists(os.path.join(path_tabelle, "Indagini_Puntuali.txt")):
            ...
            self.insert_table("indagini_puntuali", os.path.join(path_tabelle, "Indagini_Puntuali.txt"))
            if self.current_trig_sql is not None:
            ...
            if os.path.exists(os.path.join(path_tabelle, "Parametri_Puntuali.txt")):
                ...
                self.insert_table("parametri_puntuali", os.path.join(path_tabelle, "Parametri_Puntuali.txt"))
                if self.current_trig_sql is not None:
                ...
                if os.path.exists(os.path.join(path_tabelle, "Curve.txt")):
                    z_list.append("Curve")
                    self.insert_table("curve", os.path.join(path_tabelle, "Curve.txt"))
        ...
        if self.check_sito_l is True and os.path.exists(os.path.join(path_tabelle, "Indagini_Lineari.txt")):
            ...
            self.insert_table("indagini_lineari", os.path.join(path_tabelle, "Indagini_Lineari.txt"))
            if self.current_trig_sql is not None:
            ...
            if os.path.exists(os.path.join(path_tabelle, "Parametri_Lineari.txt")):
                ...
                self.insert_table("parametri_lineari", os.path.join(path_tabelle, "Parametri_Lineari.txt"))
                if self.current_trig_sql is not None:
        ...
        for chiave_fold, valore_fold in list(dizio_folder.items()):
            ...
            QgsMessageLog.logMessage("Copying: %s - %s" % (chiave_fold, valore_fold))
            if os.path.exists(valore_fold[2]):
                _folder = os.path.join(self.proj_abs_path, "Allegati", chiave_fold)
                        ...
                        try:
                            ...
                            cur.execute(
                                ...
                                (
                                    dict_sito["pkey_spu"],
                                    dict_sito["indirizzo"],
                                    dict_sito["mod_identcoord"],
                                    dict_sito["desc_modcoord"],
                                    dict_sito["quota_slm"],
                                    dict_sito["modo_quota"],
                                    dict_sito["data_sito"],
                                    dict_sito["note_sito"],
                                    lastid,
                                ),
