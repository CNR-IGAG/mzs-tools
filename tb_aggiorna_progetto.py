...
class aggiorna_progetto(QDialog, FORM_CLASS):
    ...
    def aggiorna(self, proj_path, dir_output, nome, proj_vers, new_proj_vers):
        ...
        if result == QDialog.Accepted:
            ...
            try:
                ...
                shutil.copytree(proj_path, os.path.join(
                ...
                shutil.copytree(os.path.join(proj_path, "progetto_MS", "progetto", "maschere"), os.path.join(
                    proj_path, "progetto", "maschere"))
                shutil.rmtree(os.path.join(proj_path, "progetto", "script"))
                shutil.copytree(os.path.join(proj_path, "progetto_MS", "progetto", "script"), os.path.join(
                    proj_path, "progetto", "script"))
                shutil.copyfile(os.path.join(os.path.dirname(__file__), 'versione.txt'), os.path.join(
                    proj_path, "progetto", "versione.txt"))
                os.remove(os.path.join(proj_path, "progetto_MS.qgs"))
                shutil.copyfile(os.path.join(
                    proj_path, "progetto_MS", "progetto_MS.qgs"), os.path.join(proj_path, "progetto_MS.qgs"))
                shutil.rmtree(os.path.join(proj_path, "progetto", "loghi"))
                shutil.copytree(os.path.join(proj_path, "progetto_MS", "progetto", "loghi"), os.path.join(
                    proj_path, "progetto", "loghi"))
                ...
                QMessageBox.information(
                    None, self.tr('INFORMATION!'), self.tr("The project structure has been updated!\nThe backup copy has been saved in the following directory: ") + name_output)
    ...
    def load_new_qgs_file(self, proj_path):
        ...
        logo_regio_out = os.path.join(
            proj_path, "progetto", "loghi", "logo_regio.png").replace('\\', '/')
        ...
        imageFilename = os.path.join(
            proj_path, "progetto", "loghi", "mappa_reg.png")
